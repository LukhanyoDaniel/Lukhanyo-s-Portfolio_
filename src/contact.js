...
import { Mail, Smartphone, MapPin, Instagram, Linkedin, GitHub, Facebook } from "react-feather";
      ...
      <div ref={ref} className={`transition-opacity duration-1000 ${inView ? "opacity-100" : "opacity-0"}`}>
        <div className="group bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-8 md:p-12 transform transition-transform duration-500 hover:-translate-y-3 hover:shadow-2xl">
          ...
          <div className="mt-16 text-center space-y-4 flex flex-col md:flex-row justify-center items-center gap-6 text-gray-600 dark:text-gray-300">
            <a href="mailto:lukhanyodaniel99@gmail.com" className="flex items-center gap-2 hover:underline">
              <Mail size={18} /> lukhanyodaniel99@gmail.com
            </a>
            <a href="tel:+27723888538" className="flex items-center gap-2 hover:underline">
              <Smartphone size={18} /> +27723888538
            </a>
            <div className="flex items-center gap-2">
              <MapPin size={18} /> Johannesburg, South Africa
            </div>
          </div>

          
          <div className="mt-6 flex justify-center gap-6">
            <a href="https://www.facebook.com/share/1FLuBtzx8v/" className="hover:text-indigo-500 transition-colors duration-300"><Facebook size={24} /></a>
            <a href="https://https://www.instagram.com/lukhanyodaniel9699?igsh=MTRqOG11dHVvZ2I4eg==" className="hover:text-pink-500 transition-colors duration-300"><Instagram size={24} /></a>
            <a href="https://https://www.linkedin.com/in/lukhanyo-daniel-a9720823a" className="hover:text-blue-500 transition-colors duration-300"><Linkedin size={24} /></a>
